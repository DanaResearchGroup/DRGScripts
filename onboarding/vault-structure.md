...
coding agent runs this as part of [ONBOARDING.md](./ONBOARDING.md).

## Target tree

```
Vault/
├── AGENTS.md              ← knowledge-base operating manual (seeded)
├── CLAUDE.md              ← compatibility copy of the same manual
├── Code/
│   ├── ARC/
│   └── T3/
├── knowledge/
...
The agent's **default working area is `knowledge/`** (see the seeded `AGENTS.md`). The
...
cp -n "$SEEDS/CLAUDE.md"                       "$VAULT/AGENTS.md"
...
| Seed | Becomes | Notes |
|---|---|---|
| `vault-seeds/CLAUDE.md` | `Vault/AGENTS.md` and `Vault/CLAUDE.md` | The knowledge-base operating manual. One source seeds the agent-standard file and its compatibility copy. |
